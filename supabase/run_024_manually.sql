...
-- Migration 024: Mini App URL + emojis, punchier copy, all buttons
...
-- Mark 024 as applied (so future `db push` doesn't re-run it)
INSERT INTO supabase_migrations.schema_migrations (version, name, statements) 
VALUES ('024', '024_follow_ups_url_emoji_final', '{}')
